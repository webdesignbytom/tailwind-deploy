...
function HomePageAboutSection() {
  return (
    <section className='grid w-full h-full overflow-hidden'>
      <div className=''>
        <article className='px-10 py-10 mx-auto'>
          <div className='grid'>
            <section>
              <div className=''>
            ...
            <section className='mt-6'>
              <div>
                <p>
                  ...
                  voluptatem quaerat quas vel ullam eum! Officiis dignissimos in
                  eius accusantium amet culpa facilis eos laboriosam sit ducimus
                  reiciendis sed quasi provident optio, doloremque est non
                  perspiciatis tempora blanditiis nobis quibusdam debitis
