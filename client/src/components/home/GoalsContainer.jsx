...
function GoalsContainer() {
  return (
    <section className='p-4 -mt-16 md:-mt-0 mb-48'>
      {/* Main */}
      <section className='relative grid md:grid-cols-2 gap-2 h-full'>
          ...
          <section className='grid md:h-2/3 md:my-auto items-center'>
            ...
            <div className='relative md:w-2/3 md:h-2/3 shadow-[-25px_-25px_0px_0px_rgba(74,173,55)] mx-auto'>
              <div className='absolute md:-top-20 md:-left-20 z-0 my-4 md:my-0'>
                <h3 className='hidden md:grid text-3xl md:text-8xl font-bold text__stroke'>
                  myecoapp
                </h3>
              </div>
              {/* Main article */}
              <article className='grid relative items-center z-10 shadow-[inset_-9px_-6px_20px_#46464620] md:shadow-[inset_-12px_-8px_40px_#46464620] justify-center h-full'>
                <ol className='px-1 py-6 capitalize xl:text-xl font-semibold grid gap-2 xl:gap-4'>
                  <li>
                    <div>
                      <p>
              ...
              <section className='absolute grid grid-flow-col md:grid-flow-row gap-6 -bottom-24 z-10 md:-right-24'>
                <section className='grid justify-end'>
                  <article className='h-[75px] md:h-[130px] w-[75px] md:w-[130px] outline outline-main-colour outline-4 shadow-[10px_10px_0px_0px_rgba(0,0,0)] rounded'>
                    <img
        ...
        <section className='grid mb-8'>
          <section className='grid h-2/3 my-auto'>
            <article>
              <div>
                <h2 className='text-2xl md:text-5xl relative text-main-colour text-center z-20 font-bold'>
                  OUR GOALS...
                </h2>
              </div>
              <section className='grid w-full'>
                <div className='my-4 shadow-[10px_10px_0px_0px_rgba(74,173,55)] md:w-2/3 mx-auto'>
                  <p className='leading-5 shadow-[inset_-12px_-8px_40px_#46464620] p-2'>
                    The funds we raised need to have a goal that people can get
                    behind. Our project relies on this site and our project
                    reaching as many people as possible. Growing exponentially
                    to allow us to help more people. We have three main goals we
                    hope to achieve. They are designed to make people appreciate
                    what environmental conciousness can do for a community.
                    Instead of blocking their roads we want to improve their
                    lives by improving their environment.
                  </p>
                </div>
              </section>
            </article>
