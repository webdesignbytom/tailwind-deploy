      ...
      <ol class='border-l border-neutral-300 dark:border-neutral-500 md:flex md:justify-center md:gap-6 md:border-l-0 md:border-t'>
        <li>
          ...
          <div class='ml-4 mt-2 pb-5 md:ml-0'>
            <h4 class='mb-1.5 text-xs font-semibold text-main-colour'>Title of section 1</h4>
            <p class='mb-3 text-neutral-500 text-xs leading-4 dark:text-neutral-300'>
        ...
        <li>
          ...
          <div class='ml-4 mt-2 pb-5 md:ml-0'>
            <h4 class='mb-1.5 text-xs font-semibold text-main-colour'>Title of section 2</h4>
            <p class='mb-3 text-xs text-neutral-500 leading-4 dark:text-neutral-300'>
        ...
        <li>
          ...
          <div class='ml-4 mt-2 pb-5 md:ml-0'>
            <h4 class='mb-1.5 text-xs font-semibold text-main-colour'>Title of section 3</h4>
            <p class='mb-3 text-neutral-500 text-xs leading-4 dark:text-neutral-300'>
