...
function CTA() {
  return (
    <div className='grid grid-flow-col space-x-0 w-full gap-4'>
      <Link className='bg-eco-green dark:bg-eco-green border-2 rounded-md px-4 py-2 text-center text-white dark:text-white dark:border-eco-green-dark hover:text-eco-green-dark active:text-slate-100 hover:bg-eco-green dark:hover-text-black hover:border-eco-green-dark'>
        See More
      </Link>
