...
function LoginPage() {
  ...
  return (
    <div className='bg-gray-50 dark:bg-black min-h-screen lg:max-h-screen lg:overflow-hidden lg:grid-rows-reg grid'>
      <Navbar />
      <main className='grid'>
        <section className='dark:bg-gray-900'>
          <div className='flex flex-col items-center justify-center -mt-10 px-6 py-8 mx-auto md:h-screen lg:py-0'>
