      ...
      <section className='h-screen dark:bg-black'>
        <div className='container px-6 py-12 h-full'>
          <div className='flex justify-center items-center flex-wrap h-full g-6 text-gray-800'>
            <div className='flex lg:pl-12 md:w-8/12 lg:w-6/12 mb-12 md:mb-0'>
              <img
              ...
              <form>
                ...
                <div className='flex justify-between items-center mb-6'>
                  <div className='form-group form-check'>
                    <input
                      type='checkbox'
                      className='form-check-input appearance-none h-4 w-4 border border-eco-green rounded-sm bg-white checked:bg-eco-green checked:border-eco-green focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer'
                  ...
                  <Link
                    href='#!'
                    className='text-eco-green hover:text-eco-green-med focus:text-eco-green-med active:text-eco-green-dark duration-200 transition ease-in-out'
                  >
                    Forgot password?
                  </Link>
                </div>
                ...
                <Link
                  className='bg-eco-green-med px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center mb-3'
                  href='#!'
                  role='button'
                  data-mdb-ripple='true'
                  data-mdb-ripple-color='light'
                ...
                <Link
                  className='bg-eco-green-dark px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center'
                  href='#!'
                  role='button'
                  data-mdb-ripple='true'
                  data-mdb-ripple-color='light'
