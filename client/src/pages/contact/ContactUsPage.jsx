...
function ContactUsPage() {
  ...
  return (
    <div className='bg-white dark:bg-black min-h-screen lg:max-h-screen lg:overflow-hidden lg:grid-rows-reg grid'>
      <Navbar />
      <main className='grid'>
        <div className='isolate bg-white px-6 py-24 sm:py-32 lg:py-6 lg:px-8'>
          <section>
          <div
          ...
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <p className='mt-4 text-lg leading-5 text-gray-800'>
              Send us a messgae directly throught the form below. Or select from some of our email options for departments.
            </p>
          </div>
          </section>
          <form
          ...
          >
            <section className='grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2'>
                ...
                <div className='relative mt-2.5'>
                  <div className='absolute inset-y-0 left-0 flex items-center'>
                    ...
                    <select
                      id='country'
                      name='country'
                      className='h-full rounded-md border-0 bg-transparent bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-main-colour sm:text-sm'
                    >
                      <option>US</option>
                      <option>CA</option>
                      <option>EU</option>
                  ...
                  <input
                    ...
                    id='phone-number'
                    autoComplete='tel'
                    className='block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-main-colour sm:text-sm sm:leading-6'
                  />
                </div>
              </div>
              <div className='sm:col-span-2'>
              ...
              <Switch.Group as='div' className='flex gap-x-4 sm:col-span-2'>
                ...
                <Switch.Label className='text-sm leading-6 text-gray-600'>
                  ...
                  <a href='#' className='font-semibold text-main-colour'>
                    privacy&nbsp;policy
                  </a>
                  .
                </Switch.Label>
            ...
            <section className='mt-10'>
              <button
                type='submit'
                className='block w-full rounded-md bg-main-colour px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-main-colour'
              >
                Let's talk
              </button>
            </section>
